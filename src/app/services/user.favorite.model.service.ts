...
export class UserFavoriteModelService {
  ...
  private urlForSetFavoriteModel: string = 'http://127.0.0.1:5000/UserFavoriteModel';
  private urlForDeleteFavoriteModel: string = 'http://127.0.0.1:5000/UserFavoriteModel';
  private urlForGetFavoriteModels: string = 'http://localhost:50329/api/UserFavoriteModel/GetUserFavoriteModels';
  private urlForGetFavoriteModelIds: string = 'http://127.0.0.1:5000/UserFavoriteModelIds';
  private urlForCheckExistFavoriteUserModel: string = 'http://127.0.0.1:5000/UserFavoriteModel';
